...
declare_id!("Lp7MMp1TTgz6PVVNHySHgGuZQGmxTo6QtZkb5mz6VJF");
#[constant]
...
#[account]
pub struct MintStoreAccount {
    pub authority: Pubkey,
    pub collection_mint: Pubkey,
    pub hashlist: Vec<Pubkey>,
}
